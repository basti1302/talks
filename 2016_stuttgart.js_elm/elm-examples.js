...
Elm.Example01 = Elm.Example01 || {};
Elm.Example01.make = function (_elm) {
   "use strict";
   _elm.Example01 = _elm.Example01 || {};
   if (_elm.Example01.values) return _elm.Example01.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var main = $Html.text("Hello Stuttgart!");
   return _elm.Example01.values = {_op: _op,main: main};
};
Elm.Example02 = Elm.Example02 || {};
Elm.Example02.make = function (_elm) {
   "use strict";
   _elm.Example02 = _elm.Example02 || {};
   if (_elm.Example02.values) return _elm.Example02.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var greet = function (str) {    return $Html.text(str);};
   var main = greet("Hello Stuttgart!");
   return _elm.Example02.values = {_op: _op,greet: greet,main: main};
};
Elm.Example03 = Elm.Example03 || {};
Elm.Example03.make = function (_elm) {
   "use strict";
   _elm.Example03 = _elm.Example03 || {};
   if (_elm.Example03.values) return _elm.Example03.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var greet = function (str) {    return $Html.text(str);};
   var main = greet("Hello Stuttgart!");
   return _elm.Example03.values = {_op: _op,greet: greet,main: main};
};
Elm.Example04 = Elm.Example04 || {};
Elm.Example04.make = function (_elm) {
   "use strict";
   _elm.Example04 = _elm.Example04 || {};
   if (_elm.Example04.values) return _elm.Example04.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var greet = F2(function (number,string) {    return $Html.text(A2($String.repeat,number,string));});
   var main = A2(greet,3,"Hello Stuttgart! ");
   return _elm.Example04.values = {_op: _op,greet: greet,main: main};
};
Elm.Example05 = Elm.Example05 || {};
Elm.Example05.make = function (_elm) {
   "use strict";
   _elm.Example05 = _elm.Example05 || {};
   if (_elm.Example05.values) return _elm.Example05.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var greet = F2(function (number,string) {    return $Html.text(A2($String.repeat,number,string));});
   var main = A2(greet,3,"Hello Stuttgart! ");
   return _elm.Example05.values = {_op: _op,greet: greet,main: main};
};
Elm.Example06 = Elm.Example06 || {};
Elm.Example06.make = function (_elm) {
   "use strict";
   _elm.Example06 = _elm.Example06 || {};
   if (_elm.Example06.values) return _elm.Example06.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var list = _U.list(["one","two","three","four"]);
   var main = $Html.text($Basics.toString($List.sort(list)));
   return _elm.Example06.values = {_op: _op,list: list,main: main};
};
Elm.Example07 = Elm.Example07 || {};
Elm.Example07.make = function (_elm) {
   "use strict";
   _elm.Example07 = _elm.Example07 || {};
   if (_elm.Example07.values) return _elm.Example07.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var main = A2($Html.ul,
   _U.list([]),
   _U.list([A2($Html.li,_U.list([]),_U.list([$Html.text("one")]))
           ,A2($Html.li,_U.list([]),_U.list([$Html.text("two")]))
           ,A2($Html.li,_U.list([]),_U.list([$Html.text("three")]))]));
   return _elm.Example07.values = {_op: _op,main: main};
};
Elm.Example08 = Elm.Example08 || {};
Elm.Example08.make = function (_elm) {
   "use strict";
   _elm.Example08 = _elm.Example08 || {};
   if (_elm.Example08.values) return _elm.Example08.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var toItem = function (string) {    return A2($Html.li,_U.list([]),_U.list([$Html.text(string)]));};
   var list = _U.list(["one","two","three"]);
   var main = function () {    var items = A2($List.map,toItem,list);return A2($Html.ul,_U.list([]),items);}();
   return _elm.Example08.values = {_op: _op,list: list,toItem: toItem,main: main};
};
Elm.Example09 = Elm.Example09 || {};
Elm.Example09.make = function (_elm) {
   "use strict";
   _elm.Example09 = _elm.Example09 || {};
   if (_elm.Example09.values) return _elm.Example09.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var toHtml = function (x) {    return $Html.text($Basics.toString(x));};
   var main = A2($Signal.map,toHtml,$Mouse.x);
   return _elm.Example09.values = {_op: _op,toHtml: toHtml,main: main};
};
Elm.Example10 = Elm.Example10 || {};
Elm.Example10.make = function (_elm) {
   "use strict";
   _elm.Example10 = _elm.Example10 || {};
   if (_elm.Example10.values) return _elm.Example10.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var _op = {};
   var toHtml = function (_p0) {    return $Html.text($Basics.toString(_p0));};
   var main = function () {
      var sampled2 = A2($Signal.sampleOn,$Mouse.clicks,$Mouse.y);
      var sampled1 = A2($Signal.sampleOn,$Time.every($Time.second),$Mouse.x);
      var merged = A2($Signal.merge,sampled1,sampled2);
      return A2($Signal.map,toHtml,merged);
   }();
   return _elm.Example10.values = {_op: _op,toHtml: toHtml,main: main};
};
Elm.Example11 = Elm.Example11 || {};
Elm.Example11.make = function (_elm) {
   "use strict";
   _elm.Example11 = _elm.Example11 || {};
   if (_elm.Example11.values) return _elm.Example11.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var clickCount = function () {
      var foldFunction = F2(function (click,total) {    return total + 1;});
      return A3($Signal.foldp,foldFunction,0,$Mouse.clicks);
   }();
   var toHtml = function (_p0) {    return $Html.text($Basics.toString(_p0));};
   var main = A2($Signal.map,toHtml,clickCount);
   return _elm.Example11.values = {_op: _op,toHtml: toHtml,clickCount: clickCount,main: main};
};
Elm.ExampleReactivity = Elm.ExampleReactivity || {};
Elm.ExampleReactivity.make = function (_elm) {
   "use strict";
   _elm.ExampleReactivity = _elm.ExampleReactivity || {};
   if (_elm.ExampleReactivity.values) return _elm.ExampleReactivity.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var toHtml = function (_p0) {    var _p1 = _p0;return $Html.text($Basics.toString({ctor: "_Tuple2",_0: _p1._0,_1: _p1._1}));};
   var main = A2($Signal.map,toHtml,$Mouse.position);
   return _elm.ExampleReactivity.values = {_op: _op,toHtml: toHtml,main: main};
};
